...
# Generate the biogeochemical model (CPU)
bgc_type = NiPiZD.construct()
bgc_instance = bgc_type()

# IMPORTANT: query tracer names on the CPU instance (this is the type Agate attached methods to)
tracer_names = required_biogeochemical_tracers(bgc_instance)

# Adapt the instance to GPU
...
# IMPORTANT: explicitly pass tracers so P1/P2/etc exist
