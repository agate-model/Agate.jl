# # [Traceable box model] (@id traceability_box_model_example)
...
# The traceability workflow returns the runtime biogeochemistry object and a separate construction manifest.
...
using Agate.Models: ModelId, variant, construct_with_manifest
using Agate.Models.DARWIN
using Agate.Traceability: export_manifest
using OceanBioME
...
# First, we look up a built-in DARWIN variant and construct it with traceability enabled.
...
manifest_path = "traceability_box_model_manifest.json"
