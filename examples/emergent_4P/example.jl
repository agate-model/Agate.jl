...
plankton = Dict(
    "species1" => Dict("volume" => 1.0, "volume_a" => 1.0, "volume_b" => 1.0,  
                       "pred" => 2.0, "optimum_predator_prey_ratio" => 10, "protection" => 0,
                       "growth_a" => 1, "growth_b" => 1),
    "species2" => Dict("volume" => 1.5, "volume_a" => 1.0, "volume_b" => 1.0, "pred" => 1.8, 
                       "optimum_predator_prey_ratio" => 10, "protection" => 0,
                       "growth_a" => 1, "growth_b" => 1)
)
...
emergent_functions = Dict(
    ...
    "palatability" => (dummy_emergent_palat, ["volume", "optimum_predator_prey_ratio", "protection"]),
