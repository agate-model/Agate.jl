...
"""
function summed_predation_gain(predator_index, P, assimilation_efficiency, maximum_predation_rate, holling_half_saturation, palatability)
...
function plankton_dt(plankton_index, N, P, linear_mortality, maximum_growth_rate, holling_half_saturation, maximum_predation_rate, assimilation_efficiency, palatability)
    growth =
    + photosynthetic_growth(N, P[plankton_index], maximum_growth_rate[plankton_index], holling_half_saturation[plankton_index])
    - plankton_mortality_loss(P[plankton_index], linear_mortality[plankton_index])
    - summed_predation_loss(prey_index, P, maximum_predation_rate, holling_half_saturation, palatability)
    + summed_predation_gain(predator_index, P, assimilation_efficiency, maximum_predation_rate, holling_half_saturation, palatability)
    return growth
end