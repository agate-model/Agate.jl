...
@testset "Models.Dynamic" begin
    ...
    @testset "add_bgc_methods" begin
        ...
        @testset "predation matrix" begin
            ...
            NPZD_predation = create_bgc_struct(:NPZD_predation, parameters)
            add_bgc_methods(NPZD_predation, tracers, auxiliary_fields=aux_field_vars, helper_functions=helper_functions)
            model = NPZD_predation()
