...
@testset "mass_balance" begin
    ...
    @testset "size_structured_NPZHD box model" begin
        N2P2ZHD_constructed = Agate.Models.NiPiZiHD.construct()
        model = Agate.Models.NiPiZD.instantiate(N2P2ZHD_constructed)
