...
function parameter_registry(::NiPiZDFactory)
    ...
    return ParamRegistry([
        # --- BGC scalars -----------------------------------------------------
        scalar_param(:detritus_remineralization, "Detritus remineralization rate.", 0.1213 / 86400),
        scalar_param(:mortality_export_fraction, "Fraction of mortality exported (rest becomes detritus).", 0.2),
