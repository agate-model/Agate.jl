...
@inline function _derive_palatability_matrix(::NiPiZDFactory, ctx::InteractionContext, params::NamedTuple)
    FT = ctx.FT
...
@inline function _derive_assimilation_matrix(::NiPiZDFactory, ctx::InteractionContext, params::NamedTuple)
    FT = ctx.FT
...
derived_matrix_specs(::NiPiZDFactory) = (
    ;
