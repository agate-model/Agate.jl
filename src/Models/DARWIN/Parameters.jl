...
function parameter_registry(::DarwinFactory)
    ...
    return ParamRegistry([
        ...
        scalar_param(:nitrogen_to_carbon, "Nitrogen:carbon ratio.", 0.15),
        scalar_param(:phosphorus_to_carbon, "Phosphorus:carbon ratio.", 0.009),
        scalar_param(:DOM_POM_fractionation, "Fractionation between DOM and POM.", 0.45),

        # Remineralization rates
        scalar_param(:POC_remineralization, "POC remineralization rate.", 0.1213 / 86400),
        scalar_param(:DOC_remineralization, "DOC remineralization rate.", 0.1213 / 86400),
        scalar_param(:PON_remineralization, "PON remineralization rate.", 0.1213 / 86400),
        scalar_param(:DON_remineralization, "DON remineralization rate.", 0.1213 / 86400),
        scalar_param(:POP_remineralization, "POP remineralization rate.", 0.1213 / 86400),
        scalar_param(:DOP_remineralization, "DOP remineralization rate.", 0.1213 / 86400),
        ...
        vector_param(:alpha, "Smith-style light-limitation parameter.", 0.0 / 86400),
        vector_param(
